...
function getSections(requestSpeaker: RequestSpeakerContent | null): RequestSpeakerContentJson {
  if (!requestSpeaker?.data) {
    return {};
  }
  const data = requestSpeaker.data;
  // Support both shapes: flat and nested
  return (data.data && typeof data.data === "object" ? data : data) as RequestSpeakerContentJson;
}
